        ...
        <div className={`relative backdrop-blur-xl bg-white/5 rounded-3xl shadow-2xl overflow-hidden border border-white/10 transition-all duration-700 ${isConverting ? 'scale-95' : 'scale-100'}`}>
          ...
          <div className="p-8">
            <div className="flex justify-center mb-8">
              <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-200 text-center relative">
                <span className="relative z-10">QUANTUM CONVERTER</span>
                <span className="absolute -bottom-1 left-0 right-0 h-1 bg-cyan-400/30 rounded-full animate-pulse"></span>
              </h1>
            </div>
